...
const ITEM_CATALOG = [
  ...
  { cat:'Équipement', name:'Armure d\'étoffe', sub:'Légère · 13 ar · +10 Armure', ic:'🛡', img:'', type:'armor', armorClass:'legere', weight:4, mods:{ armure:10 } },
  ...
  { cat:'Équipement', name:'Cape du néant', sub:'Légère · 13 ar · +10 Rés. Mag', ic:'🌀', img:'', type:'armor', armorClass:'legere', weight:4, mods:{ resmag:10 } },
  ...
  { cat:'Équipement', name:'Cape doublée', sub:'Légère · 13 ar · +4 Armure, +4 Rés. Mag', ic:'⚜', img:'', type:'armor', armorClass:'legere', weight:4, mods:{ armure:4, resmag:4 } },
  ...
  { cat:'Équipement', name:'Gambison clouté', sub:'Légère · 13 ar · +21 PV, +4 Armure', ic:'🦺', img:'', type:'armor', armorClass:'legere', weight:4, mods:{ hp:21, armure:4 } },
  ...
  { cat:'Équipement', name:'Tenue de l\'initié', sub:'Légère · 13 ar · +21 PV, +4 Rés. Mag', ic:'👘', img:'', type:'armor', armorClass:'legere', weight:4, mods:{ hp:21, resmag:4 } },
