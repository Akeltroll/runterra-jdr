...
const CHARACTERS = [
  ...
  mkChar({ id:'lunick', name:'Elias Crowe', player:'Fab', title:'Capitaine corsaire', cls:'Navigateur arcanique',
    ...
    inv:[
      ...
      { cat:'Consommables', name:'Potion soin mineur', sub:'Rend 15 + 15% HP', qty:1, ic:'🧪', img:'ATH/Consommables/potion-soin-mineure.webp' },
      { cat:'Consommables', name:'Potion mana mineur', sub:'Rend 10 + 10% Mana', qty:1, ic:'🔵', img:'ATH/Consommables/potion-mana-mineure.webp' },
      { cat:'Butin', name:'Tricorne', sub:"Valeur d'1 pièce d'or (sentimental)", qty:1, ic:'🎩', img:'ATH/Butin/tricorne-capitaine.webp' },
      { cat:'Butin', name:'Boussole', sub:'1 pa', qty:1, ic:'🧭', img:'ATH/Butin/boussole-capitaine.webp' },
  ...
  mkChar({ id:'jett', name:'Jett', player:'Steph', title:'La Flèche Hextech', cls:'Artificier',
    ...
    inv:[
      ...
      { cat:'Équipement', name:"Livre : L'Histoire de Runeterra", sub:'Lecture', qty:1, ic:'📖', img:'ATH/Butin/runeterra-quaestus.webp' },
      { cat:'Équipement', name:'Boîte à outils', sub:'', qty:1, ic:'🧰', img:'ATH/Butin/coffret-terrain.webp' },
      { cat:'Consommables', name:'Potion soin mineur', sub:'Rend 15 + 15% HP', qty:0, ic:'🧪', img:'ATH/Consommables/potion-soin-mineure.webp' },
      { cat:'Consommables', name:'Potion mana mineur', sub:'Rend 10 + 10% Mana', qty:1, ic:'🔵', img:'ATH/Consommables/potion-mana-mineure.webp' },
      { cat:'Consommables', name:'Potion néfaste inconnue', sub:'Inconnue', qty:2, ic:'🧫', img:'ATH/Consommables/potion-non-identifiee.webp' },
      { cat:'Consommables', name:'Pierre magique de transmutation', sub:'', qty:1, ic:'🪨', img:'ATH/Butin/pierre-transmutation.webp' },
    ],
    coins:{ plat:0, or:10, arg:10, cuiv:10 },
  }),
];
...
const ITEM_CATALOG = [
  ...
  { cat:'Butin', name:'Pierre de transmutation', sub:'Transmute la matière',      ic:'🪨', img:'ATH/Butin/pierre-transmutation.webp', type:'' },
  ...
  { cat:'Butin', name:'Boussole',               sub:'Indique le nord',            ic:'🧭', img:'ATH/Butin/boussole-capitaine.webp',           type:'' },
  ...
  { cat:'Butin', name:'Boîte à outils',         sub:'Outils de réparation',       ic:'🧰', img:'ATH/Butin/coffret-terrain.webp',     type:'' },
  { cat:'Butin', name:'Livre : L\'Histoire de Runeterra', sub:'Lecture',          ic:'📖', img:'ATH/Butin/runeterra-quaestus.webp',     type:'' },
  { cat:'Butin', name:'Tricorne',               sub:'Couvre-chef de pirate',      ic:'🎩', img:'ATH/Butin/tricorne-capitaine.webp',           type:'' },
