...
const CHARACTERS = [
  mkChar({ id:'rathael', name:'Rathäel', player:'JB', title:'Le Serment Brisé', cls:'Chevalier déchu',
    ...
    inv:[
      ...
      { cat:'Consommables', name:'Potion soin mineur', sub:'Rend 15 + 15% HP', qty:0, ic:'🧪', img:'ATH/Consommables/potion-soin-mineure.webp' },
      { cat:'Consommables', name:'Potion mana mineur', sub:'Rend 10 + 10% Mana', qty:1, ic:'🔵', img:'ATH/Consommables/potion-mana-mineure.webp' },
      { cat:'Consommables', name:'Kéminite', sub:'Sert à appeler Taliyah', qty:1, ic:'🔮', img:'ATH/Butin/keminite.webp', type:'' },
    ],
  ...
  mkChar({ id:'urskaar', name:'Urskaar', player:'Baptiste', title:'Le Poing de Fer', cls:'Pugiliste',
    ...
    inv:[
      ...
      { cat:'Consommables', name:'Potion soin mineur', sub:'Rend 15 + 15% HP', qty:1, ic:'🧪', img:'ATH/Consommables/potion-soin-mineure.webp' },
      { cat:'Consommables', name:'Potion mana mineur', sub:'Rend 10 + 10% Mana', qty:1, ic:'🔵', img:'ATH/Consommables/potion-mana-mineure.webp' },
      { cat:'Consommables', name:'Kéminite', sub:'Appel Taliyah', qty:1, ic:'🔮', img:'ATH/Butin/keminite.webp' },
    ],
    coins:{ plat:0, or:10, arg:10, cuiv:10 },
  }),
  mkChar({ id:'smith', name:'Smith', player:'Erwan', title:'La Lame Silencieuse', cls:'Duelliste',
    ...
    inv:[
      ...
      { cat:'Consommables', name:'Potion soin mineur', sub:'Rend 15 + 15% HP', qty:1, ic:'🧪', img:'ATH/Consommables/potion-soin-mineure.webp' },
      { cat:'Consommables', name:'Potion mana mineur', sub:'Rend 10 + 10% Mana', qty:1, ic:'🔵', img:'ATH/Consommables/potion-mana-mineure.webp' },
      { cat:'Consommables', name:'Parchemins (NI)', sub:'Non identifiés', qty:2, ic:'📜', img:'ATH/Consommables/parchemin-bas-niveau.webp' },
      { cat:'Consommables', name:'Cristal explosif', sub:'Réactif instable', qty:1, ic:'💎', img:'ATH/Butin/cristal-explosif.webp' },
      { cat:'Consommables', name:'Cristal très explosif', sub:'Très instable', qty:1, ic:'💥', img:'ATH/Butin/gros-cristal-explosif.webp' },
      { cat:'Butin', name:'Cuir de brackern', sub:'Tutoriel', qty:1, ic:'🦴', img:'ATH/Butin/peaux-cuirs.webp' },
    ],
    coins:{ plat:0, or:10, arg:10, cuiv:10 },
  }),
  ...
  mkChar({ id:'lunick', name:'Elias Crowe', player:'Fab', title:'Capitaine corsaire', cls:'Navigateur arcanique',
    ...
    inv:[
      ...
      { cat:'Équipement', name:'Dague simple', sub:'+10 AD', qty:1, ic:'🗡', img:'ATH/Armes/dague-simple.webp', type:'accessory', weight:1, mods:{ ad:10 } },
      { cat:'Équipement', name:'Hachette', sub:'Arme secondaire · brisage · 1 pa', qty:1, ic:'🪓', img:'ATH/Armes/hachette.webp' },
      { cat:'Consommables', name:'Potion soin mineur', sub:'Rend 15 + 15% HP', qty:1, ic:'🧪', img:'ATH/Consommables/potion-soin-mineure.webp' },
      { cat:'Consommables', name:'Potion mana mineur', sub:'Rend 10 + 10% Mana', qty:1, ic:'🔵', img:'ATH/Consommables/potion-mana-mineure.webp' },
      { cat:'Butin', name:'Tricorne du capitaine', sub:"Valeur d'1 pièce d'or (sentimental)", qty:1, ic:'🎩', img:'ATH/Butin/tricorne-capitaine.webp' },
      { cat:'Butin', name:'Boussole du capitaine', sub:'1 pa', qty:1, ic:'🧭', img:'ATH/Butin/boussole-capitaine.webp' },
      { cat:'Butin', name:'Carte', sub:'N/A', qty:1, ic:'🗺', img:'ATH/Butin/carte.webp' },
      { cat:'Butin', name:'Gourde', sub:'10 pc', qty:1, ic:'🧴', img:'ATH/Butin/gourde.webp' },
    ],
    coins:{ plat:0, or:10, arg:10, cuiv:10 },
  }),
  mkChar({ id:'jett', name:'Jett', player:'Steph', title:'La Flèche Hextech', cls:'Artificier',
    ...
    inv:[
      ...
      { cat:'Équipement', name:'Dague simple', sub:'+10 AD', qty:1, ic:'🗡', img:'ATH/Armes/dague-simple.webp', type:'accessory', weight:1, mods:{ ad:10 } },
      { cat:'Butin', name:"Runeterra Quaestus - Piltovian's Encyclopediae", sub:'Lecture', qty:1, ic:'📖', img:'ATH/Butin/runeterra-quaestus.webp' },
      { cat:'Butin', name:'Coffret de terrain', sub:'', qty:1, ic:'🧰', img:'ATH/Butin/coffret-terrain.webp' },
      { cat:'Consommables', name:'Potion soin mineur', sub:'Rend 15 + 15% HP', qty:0, ic:'🧪', img:'ATH/Consommables/potion-soin-mineure.webp' },
      { cat:'Consommables', name:'Potion mana mineur', sub:'Rend 10 + 10% Mana', qty:1, ic:'🔵', img:'ATH/Consommables/potion-mana-mineure.webp' },
      { cat:'Consommables', name:'Potion néfaste inconnue', sub:'Inconnue', qty:2, ic:'🧫', img:'ATH/Consommables/potion-non-identifiee.webp' },
      { cat:'Consommables', name:'Pierre de transmutation (usage unique)', sub:'', qty:1, ic:'🪨', img:'ATH/Butin/pierre-transmutation.webp' },
    ],
    coins:{ plat:0, or:10, arg:10, cuiv:10 },
  }),
];
...
const ITEM_CATALOG = [
  ...
  { cat:'Consommables', name:'Potion soin mineur',        sub:'Rend 15 + 15% HP',  ic:'🧪', img:'ATH/Consommables/potion-soin-mineure.webp',        type:'' },
  { cat:'Consommables', name:'Potion soin intermédiaire', sub:'Rend 30 + 20% HP',  ic:'🧪', img:'ATH/Consommables/potion-soin-intermediaire.webp', type:'' },
  { cat:'Consommables', name:'Potion soin avancé',        sub:'Rend 50 + 25% HP',  ic:'🧪', img:'ATH/Consommables/potion-soin-superieure.webp',        type:'' },
  { cat:'Consommables', name:'Potion soin ultime',        sub:'Rend 100 + 30% HP', ic:'🧪', img:'ATH/Consommables/potion-soin-ultime.webp',        type:'' },
  // Consommables — potions de mana
  { cat:'Consommables', name:'Potion mana mineur',        sub:'Rend 10 + 10% Mana', ic:'🔵', img:'ATH/Consommables/potion-mana-mineure.webp',        type:'' },
  { cat:'Consommables', name:'Potion mana intermédiaire', sub:'Rend 25 + 15% Mana', ic:'🔵', img:'ATH/Consommables/potion-mana-intermediaire.webp', type:'' },
  { cat:'Consommables', name:'Potion mana avancé',        sub:'Rend 40 + 20% Mana', ic:'🔵', img:'ATH/Consommables/potion-mana-superieure.webp',        type:'' },
  { cat:'Consommables', name:'Potion mana ultime',        sub:'Rend 75 + 25% Mana', ic:'🔵', img:'ATH/Consommables/potion-mana-ultime.webp',        type:'' },
  // Consommables — divers
  { cat:'Consommables', name:'Potion néfaste inconnue',   sub:'Effet inconnu — à vos risques', ic:'☠', img:'ATH/Consommables/potion-non-identifiee.webp', type:'' },
  { cat:'Consommables', name:'Kéminite',                  sub:'Sert à appeler Taliyah', ic:'🔮', img:'ATH/Butin/keminite.webp',               type:'' },
  { cat:'Consommables', name:'Cristal explosif',          sub:'Explose à l\'impact',    ic:'💥', img:'ATH/Butin/cristal-explosif.webp',        type:'' },
  { cat:'Consommables', name:'Cristal très explosif',     sub:'Explosion majeure',      ic:'💥', img:'ATH/Butin/gros-cristal-explosif.webp',   type:'' },
  // Butin
  ...
  { cat:'Consommables', name:'Pierre de transmutation (usage unique)', sub:'Transmute la matière',      ic:'🪨', img:'ATH/Butin/pierre-transmutation.webp', type:'' },
  { cat:'Butin', name:'Cuir de brackern',       sub:'Dépouille à revendre',       ic:'🦴', img:'ATH/Butin/peaux-cuirs.webp',           type:'' },
  { cat:'Butin', name:'Carte',                  sub:'Indique un lieu',            ic:'🗺', img:'ATH/Butin/carte.webp',              type:'' },
  { cat:'Butin', name:'Boussole du capitaine',               sub:'Indique le nord',            ic:'🧭', img:'ATH/Butin/boussole-capitaine.webp',           type:'' },
  { cat:'Butin', name:'Parchemin',              sub:'Texte ancien',               ic:'📜', img:'ATH/Consommables/parchemin-bas-niveau.webp',          type:'' },
  { cat:'Butin', name:'Gourde',                 sub:'Contient de l\'eau',         ic:'🧴', img:'ATH/Butin/gourde.webp',             type:'' },
  { cat:'Butin', name:'Coffret de terrain',         sub:'Outils de réparation',       ic:'🧰', img:'ATH/Butin/coffret-terrain.webp',     type:'' },
  { cat:'Butin', name:"Runeterra Quaestus - Piltovian's Encyclopediae", sub:'Lecture',          ic:'📖', img:'ATH/Butin/runeterra-quaestus.webp',     type:'' },
  { cat:'Butin', name:'Tricorne du capitaine',               sub:'Couvre-chef de pirate',      ic:'🎩', img:'ATH/Butin/tricorne-capitaine.webp',           type:'' },
  ...
  { cat:'Équipement', name:'Dague simple', sub:'+10 AD', ic:'🗡', img:'ATH/Armes/dague-simple.webp', type:'accessory', weight:1, mods:{ ad:10 } },
  ...
  { cat:'Équipement', name:'Veste matelassée', sub:'Légère · 13 ar · +50 PV', ic:'🧥', img:'ATH/Armures/veste-matelassee.webp', type:'armor', armorClass:'legere', weight:4, mods:{ hp:50 } },
  { cat:'Équipement', name:'Plastron de cuir bouilli', sub:'Intermédiaire · 20 ar · +100 PV · −1 dépl.', ic:'🧥', img:'ATH/Armures/plastron-cuir-bouilli.webp', type:'armor', armorClass:'intermediaire', weight:10, mods:{ hp:100 } },
  { cat:'Équipement', name:'Cuirasse de colosse', sub:'Lourde · 32 ar · +150 PV · −1 dépl., −1 init., malus Hab.', ic:'🧥', img:'ATH/Armures/cuirasse-colosse.webp', type:'armor', armorClass:'lourde', weight:20, mods:{ hp:150 } },
  { cat:'Équipement', name:'Armure d\'étoffe', sub:'Légère · 13 ar · +10 Armure', ic:'🛡', img:'ATH/Armures/armure-etoffe.webp', type:'armor', armorClass:'legere', weight:4, mods:{ armure:10 } },
  { cat:'Équipement', name:'Cotte de mailles', sub:'Intermédiaire · 20 ar · +15 Armure · −1 dépl.', ic:'🛡', img:'ATH/Armures/cotte-mailles.webp', type:'armor', armorClass:'intermediaire', weight:10, mods:{ armure:15 } },
  { cat:'Équipement', name:'Harnois de plates', sub:'Lourde · 32 ar · +25 Armure · −1 dépl., −1 init., malus Hab.', ic:'🛡', img:'ATH/Armures/harnois-plates.webp', type:'armor', armorClass:'lourde', weight:20, mods:{ armure:25 } },
  { cat:'Équipement', name:'Cape du néant', sub:'Légère · 13 ar · +10 Rés. Mag', ic:'🌀', img:'ATH/Armures/cape-neant.webp', type:'armor', armorClass:'legere', weight:4, mods:{ resmag:10 } },
  { cat:'Équipement', name:'Manteau de négatron', sub:'Intermédiaire · 20 ar · +15 Rés. Mag · −1 dépl.', ic:'🌀', img:'ATH/Armures/manteau-negatron.webp', type:'armor', armorClass:'intermediaire', weight:10, mods:{ resmag:15 } },
  { cat:'Équipement', name:'Drapé d\'antimagie', sub:'Lourde · 32 ar · +25 Rés. Mag · −1 dépl., −1 init., malus Hab.', ic:'🌀', img:'ATH/Armures/drape-antimagie.webp', type:'armor', armorClass:'lourde', weight:20, mods:{ resmag:25 } },
  { cat:'Équipement', name:'Cape doublée', sub:'Légère · 13 ar · +4 Armure, +4 Rés. Mag', ic:'⚜', img:'ATH/Armures/cape-doublee.webp', type:'armor', armorClass:'legere', weight:4, mods:{ armure:4, resmag:4 } },
  { cat:'Équipement', name:'Harnois composite', sub:'Intermédiaire · 20 ar · +6 Armure, +6 Rés. Mag · −1 dépl.', ic:'⚜', img:'ATH/Armures/harnois-composite.webp', type:'armor', armorClass:'intermediaire', weight:10, mods:{ armure:6, resmag:6 } },
  { cat:'Équipement', name:'Garde-corps runique', sub:'Lourde · 32 ar · +10 Armure, +10 Rés. Mag · −1 dépl., −1 init., malus Hab.', ic:'⚜', img:'ATH/Armures/garde-corps-runique.webp', type:'armor', armorClass:'lourde', weight:20, mods:{ armure:10, resmag:10 } },
  { cat:'Équipement', name:'Gambison clouté', sub:'Légère · 13 ar · +21 PV, +4 Armure', ic:'🦺', img:'ATH/Armures/gambison-cloute.webp', type:'armor', armorClass:'legere', weight:4, mods:{ hp:21, armure:4 } },
  { cat:'Équipement', name:'Brigandine renforcée', sub:'Intermédiaire · 20 ar · +40 PV, +6 Armure · −1 dépl.', ic:'🦺', img:'ATH/Armures/brigandine-renforcee.webp', type:'armor', armorClass:'intermediaire', weight:10, mods:{ hp:40, armure:6 } },
  { cat:'Équipement', name:'Mailles du gardien', sub:'Lourde · 32 ar · +60 PV, +10 Armure · −1 dépl., −1 init., malus Hab.', ic:'🦺', img:'ATH/Armures/mailles-gardien.webp', type:'armor', armorClass:'lourde', weight:20, mods:{ hp:60, armure:10 } },
  { cat:'Équipement', name:'Tenue de l\'initié', sub:'Légère · 13 ar · +21 PV, +4 Rés. Mag', ic:'👘', img:'ATH/Armures/tenue-initie.webp', type:'armor', armorClass:'legere', weight:4, mods:{ hp:21, resmag:4 } },
  { cat:'Équipement', name:'Robe runique', sub:'Intermédiaire · 20 ar · +40 PV, +6 Rés. Mag · −1 dépl.', ic:'👘', img:'ATH/Armures/robe-runique.webp', type:'armor', armorClass:'intermediaire', weight:10, mods:{ hp:40, resmag:6 } },
  { cat:'Équipement', name:'Cuirasse du templier', sub:'Lourde · 32 ar · +60 PV, +10 Rés. Mag · −1 dépl., −1 init., malus Hab.', ic:'👘', img:'ATH/Armures/cuirasse-templier.webp', type:'armor', armorClass:'lourde', weight:20, mods:{ hp:60, resmag:10 } },
];
